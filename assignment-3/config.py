...
# override=False: shell env vars take precedence over .env
...
def get_llm(temperature=0):
    ...
    if provider == "google":
        ...
        if not api_key:
            print(colored("[WARN] GOOGLE_API_KEY not found!", "red"))
        ...
        if not api_key:
            print(colored("[WARN] OPENAI_API_KEY not found!", "red"))
        kwargs = {
        ...
        if not api_key:
            print(colored("[WARN] ANTHROPIC_API_KEY not found!", "red"))
